"""Decision Tree Regressor Pipeline Module.

This module implements a pipeline class for decision tree regression models.
It includes functionality for data loading, training, prediction, and metric
...
class DecisionTreeRegressorPipeline(BasePipeline):
    """Decision Tree Regressor Pipeline Class."""

    def __init__(self, config: PipelineConfig) -> None:
        """Initialize the Decision Tree Regressor Pipeline.
