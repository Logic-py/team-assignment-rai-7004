...
Questo modulo fornisce una classe Factory per costruire pipeline specifiche basate su una configurazione fornita.
Supporta diversi algoritmi come regressione lineare, classificatori e regressori con alberi decisionali.
"""
